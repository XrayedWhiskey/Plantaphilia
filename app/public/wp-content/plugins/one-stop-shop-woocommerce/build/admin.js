...
(function ($, oss) {
  oss.admin = {
    ...
    init: function () {
      ...
      $(document).on('change', 'select#oss-report-type', self.onChangeReportType).on('click', 'a.oss-add-new-tax-class-by-country', self.onAddNewTaxClassCountry).on('click', 'a.oss-remove-tax-class-by-country', self.onRemoveTaxClassCountry);
...
((window.oss = window.oss || {})["static"] = window.oss["static"] || {}).admin = __webpack_exports__;
/******/ })()
;