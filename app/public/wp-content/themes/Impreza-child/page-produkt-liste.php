...
var EDIT_FIELDS = [
    ...
    { key:'delivery_time_days',     label:'Lieferzeit',              type:'number', min:'0', suffix:'Tage' },
    { key:'_care_header',           label:'Pflege-Infos',            type:'divider' },
    { key:'care_light',             label:'Licht',                   type:'select', staticOpts:[{v:'',l:'— nicht angegeben —'},{v:'vollsonne',l:'Vollsonne'},{v:'sonnig',l:'Sonnig'},{v:'halbschatten',l:'Halbschatten'},{v:'schatten',l:'Schatten'}] },
    { key:'care_water',             label:'Wasser',                  type:'select', staticOpts:[{v:'',l:'— nicht angegeben —'},{v:'viel',l:'Viel (feucht halten)'},{v:'maessig',l:'Mäßig'},{v:'wenig',l:'Wenig (trocken halten)'}] },
