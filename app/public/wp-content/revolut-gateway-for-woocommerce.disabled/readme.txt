...
* Fixed shipping calculation for UK and CA postal codes with Apple Pay in Express checkout

= 4.22.3 =
* Fixed an issue where guest users were unable to place order in blocks checkout
...
= 4.21.2 =
* Fixed guest checkout issue when auto login feature is enabled

= 4.21.1 =
* Improved payment flow for processing subscriptions
...
= 4.20.9 =
* Added Revolut Pro account support

= 4.20.8 =
* Refactored payment processing flow

= 4.20.7 =
* UX adjustments to oauth connection flow

= 4.20.6 =
* Fixed an issue preventing guest users from completing subscription payments

= 4.20.5 =
* Optimized count of db queries

= 4.20.4 =
* Fixed an issue that was preventing renewal orders from being captured

= 4.20.3 =
* Enable Pay by bank for UK merchants

= 4.20.2 =
* Fixed an issue where payments failed to capture after remaining in the processing state for too long

= 4.20.1 =
* Adjusted payment blocks compatibility for use with zero-decimal currency settings

= 4.20.0 =
* Stability improvements

= 4.19.9 =
* Fixed domain registrations for OAuth connection

= 4.19.8 =
* Improve OAuth labels 

= 4.19.7 =
* Fixed PHP7 compatibility

= 4.19.6 =
* Added OAuth Connect feature

= 4.19.5 =
* Fixed Admin Post Page crash
...
= 4.19.1 =
* Fixed an issue in express checkout flow where changing the product variation did not update the order total

= 4.19.0 =
* Added compatibility with Woocommerce Shipment Tracking plugin for proof of shipment collection
* Disabled ApplePay billing address requirement in checkout page

= 4.18.11 =
* Adjusted reward banner heading and subtext
...
= 4.18.8 =
* Fixed issue on subscriptions renewals
* Stability improvements to upsell banners

= 4.18.7 =
* Added configuration for order external reference selection
* Disabled postcode requirement for card payment on block checkout

= 4.18.6 =
* Fixed an issue where cart block is not loading when payment methods are not available

= 4.18.5 =
* Fixed Revolut Pay cart page Fast Checkout flow charging outdated order amount.

= 4.18.4 =
* Fixed subscription compatibility on Block Checkout 

= 4.18.3 =
* Optimized assets loading to enhance performance.
