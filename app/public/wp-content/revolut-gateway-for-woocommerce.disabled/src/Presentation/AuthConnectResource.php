...
use Revolut\Plugin\Services\AuthConnect\AuthConnectResourceContract;
use Revolut\Plugin\Services\AuthConnect\AuthConnectServiceInterface;

class AuthConnectResource implements AuthConnectResourceContract, HttpResourceInterface
{
    private $authConnectService;

    function __construct(AuthConnectServiceInterface $authConnectService)
    {
